    ...
    <section>
        ...
        <nav>
          <div class="leftside">
            ...
            <ul>
               <a style="text-decoration:none; color:inherit;" href="login.php"><li>Login</li></a> 
                <a style="text-decoration:none; color:inherit;" href="regestration.php"><span><li>Signup</li></span></a>
                <li>About us</li>
            </ul>
